 ...
 */
public class NestedQuantizedVectorIdsKNNIterator extends QuantizedVectorIdsKNNIterator {
    private final BitSet parentBitSet;

    public NestedQuantizedVectorIdsKNNIterator(
        ...
        super(filterIdsIterator, queryVector, knnFloatVectorValues, spaceType, segmentLevelQuantizationInfo);
